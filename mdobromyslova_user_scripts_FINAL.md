...
13.	 После выставления нужных значений пользователь нажимает enter.
...
10.	Пользователь нажимает enter.
...
10.	 Если пароль корректный, пользователь нажимает кнопку enter.
...
7.	Если название корректное, пользователь нажимает enter.
